...
public slots:
    ...
    void handleInitialStateChanged(IAttribute*);
    void handleFinalStateChanged(IAttribute*);
    void handleAttributeChanged(IAttribute*);
    void handleExitActionChanged(IAttribute*);
    void handleEntryActionChanged(IAttribute*);
